...
// @ts-ignore
import { SupportedBlockchain } from './supported-blockchain';

/**
 * 
 * @export
 * @interface SupportedBlockChainsResponse
 */
export interface SupportedBlockChainsResponse {
    /**
     * Boolean representing if all blockchains are supported
     * @type {boolean}
     * @memberof SupportedBlockChainsResponse
     */
    'supportsAllBlockchains': boolean;
    /**
     * List of supported blockchains
     * @type {Array<SupportedBlockchain>}
     * @memberof SupportedBlockChainsResponse
     */
