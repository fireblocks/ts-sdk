 ...
 * 
 * @export
 * @interface ReissueMultichainTokenRequestDto
 */
export interface ReissueMultichainTokenRequestDto {
     ...
     * @type {string}
     * @memberof ReissueMultichainTokenRequestDto
     */
     ...
     * @memberof ReissueMultichainTokenRequestDto
     */
    'feeLevel'?: ReissueMultichainTokenRequestDtoFeeLevelEnum;
}

export const ReissueMultichainTokenRequestDtoFeeLevelEnum = {
    Low: 'LOW',
    Medium: 'MEDIUM',
    High: 'HIGH'
} as const;

export type ReissueMultichainTokenRequestDtoFeeLevelEnum = typeof ReissueMultichainTokenRequestDtoFeeLevelEnum[keyof typeof ReissueMultichainTokenRequestDtoFeeLevelEnum];
