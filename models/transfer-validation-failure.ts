 ...
 * 
 * @export
 * @interface TransferValidationFailure
 */
export interface TransferValidationFailure {
    /**
     * 
     * @type {string}
     * @memberof TransferValidationFailure
     */
    'reason': TransferValidationFailureReasonEnum;
    /**
     * 
     * @type {{ [key: string]: any; }}
     * @memberof TransferValidationFailure
...
export const TransferValidationFailureReasonEnum = {
...
export type TransferValidationFailureReasonEnum = typeof TransferValidationFailureReasonEnum[keyof typeof TransferValidationFailureReasonEnum];
