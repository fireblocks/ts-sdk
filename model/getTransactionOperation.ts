...
*/
export enum GetTransactionOperation {
    Transfer = <any> 'TRANSFER',
    Burn = <any> 'BURN',
    ContractCall = <any> 'CONTRACT_CALL',
    Mint = <any> 'MINT',
    Raw = <any> 'RAW',
    TypedMessage = <any> 'TYPED_MESSAGE',
    EnableAsset = <any> 'ENABLE_ASSET',
    Stake = <any> 'STAKE',
    Unstake = <any> 'UNSTAKE',
    Withdraw = <any> 'WITHDRAW',
    RedeemFromCompound = <any> 'REDEEM_FROM_COMPOUND',
    SupplyToCompound = <any> 'SUPPLY_TO_COMPOUND'
}
