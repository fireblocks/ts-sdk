...
// @ts-ignore
import { CreateMultichainTokenRequestDto } from '../models';
// @ts-ignore
import { CreateTokenRequestDto } from '../models';
// @ts-ignore
import { DeployableAddressResponseDto } from '../models';
// @ts-ignore
import { DeployedContractNotFoundError } from '../models';
// @ts-ignore
import { ErrorSchema } from '../models';
// @ts-ignore
import { GetDeployableAddressRequestDto } from '../models';
// @ts-ignore
...
// @ts-ignore
import { ReissueMultichainTokenRequestDto } from '../models';
// @ts-ignore
...
export const TokenizationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetDeployableAddressRequestDto} getDeployableAddressRequestDto 
         * @param {string} [idempotencyKey] A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getDeployableAddress: async (getDeployableAddressRequestDto: GetDeployableAddressRequestDto, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            assertParamExists('getDeployableAddress', 'getDeployableAddressRequestDto', getDeployableAddressRequestDto)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(getDeployableAddressRequestDto, localVarRequestOptions, configuration)
         ...
         * @param {CreateMultichainTokenRequestDto} createMultichainTokenRequestDto 
         * @param {string} [idempotencyKey] A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        issueTokenMultiChain: async (createMultichainTokenRequestDto: CreateMultichainTokenRequestDto, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            assertParamExists('issueTokenMultiChain', 'createMultichainTokenRequestDto', createMultichainTokenRequestDto)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createMultichainTokenRequestDto, localVarRequestOptions, configuration)
         ...
         * @param {ReissueMultichainTokenRequestDto} reissueMultichainTokenRequestDto 
         * @param {string} tokenLinkId The ID of the token link
         * @param {string} [idempotencyKey] A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        reIssueTokenMultiChain: async (reissueMultichainTokenRequestDto: ReissueMultichainTokenRequestDto, tokenLinkId: string, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            assertParamExists('reIssueTokenMultiChain', 'reissueMultichainTokenRequestDto', reissueMultichainTokenRequestDto)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(reissueMultichainTokenRequestDto, localVarRequestOptions, configuration)
...
export const TokenizationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getDeployableAddress(getDeployableAddressRequestDto: GetDeployableAddressRequestDto, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeployableAddressResponseDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDeployableAddress(getDeployableAddressRequestDto, idempotencyKey, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async issueTokenMultiChain(createMultichainTokenRequestDto: CreateMultichainTokenRequestDto, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IssueTokenMultichainResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.issueTokenMultiChain(createMultichainTokenRequestDto, idempotencyKey, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async reIssueTokenMultiChain(reissueMultichainTokenRequestDto: ReissueMultichainTokenRequestDto, tokenLinkId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IssueTokenMultichainResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.reIssueTokenMultiChain(reissueMultichainTokenRequestDto, tokenLinkId, idempotencyKey, options);
            const index = configuration?.serverIndex ?? 0;
...
export const TokenizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDeployableAddress(requestParameters: TokenizationApiGetDeployableAddressRequest, options?: RawAxiosRequestConfig): AxiosPromise<DeployableAddressResponseDto> {
            return localVarFp.getDeployableAddress(requestParameters.getDeployableAddressRequestDto, requestParameters.idempotencyKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Get collections (paginated)
         * @summary Get collections
        ...
        issueTokenMultiChain(requestParameters: TokenizationApiIssueTokenMultiChainRequest, options?: RawAxiosRequestConfig): AxiosPromise<IssueTokenMultichainResponse> {
            return localVarFp.issueTokenMultiChain(requestParameters.createMultichainTokenRequestDto, requestParameters.idempotencyKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Link an a contract
         * @summary Link a contract
        ...
        reIssueTokenMultiChain(requestParameters: TokenizationApiReIssueTokenMultiChainRequest, options?: RawAxiosRequestConfig): AxiosPromise<IssueTokenMultichainResponse> {
            return localVarFp.reIssueTokenMultiChain(requestParameters.reissueMultichainTokenRequestDto, requestParameters.tokenLinkId, requestParameters.idempotencyKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Unlink a token. The token will be unlinked from the workspace. The token will not be deleted on chain nor the refId, only the link to the workspace will be removed.
         * @summary Unlink a token
...
export interface TokenizationApiGetDeployableAddressRequest {
    /**
     * 
     * @type {GetDeployableAddressRequestDto}
     * @memberof TokenizationApiGetDeployableAddress
     */
    readonly getDeployableAddressRequestDto: GetDeployableAddressRequestDto
...
export interface TokenizationApiIssueTokenMultiChainRequest {
    /**
     * 
     * @type {CreateMultichainTokenRequestDto}
     * @memberof TokenizationApiIssueTokenMultiChain
     */
    readonly createMultichainTokenRequestDto: CreateMultichainTokenRequestDto
...
export interface TokenizationApiReIssueTokenMultiChainRequest {
    /**
     * 
     * @type {ReissueMultichainTokenRequestDto}
     * @memberof TokenizationApiReIssueTokenMultiChain
     */
    readonly reissueMultichainTokenRequestDto: ReissueMultichainTokenRequestDto
...
export class TokenizationApi extends BaseAPI {
    ...
    public getDeployableAddress(requestParameters: TokenizationApiGetDeployableAddressRequest) {
        return TokenizationApiFp(this.configuration).getDeployableAddress(requestParameters.getDeployableAddressRequestDto, requestParameters.idempotencyKey).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
    ...
    public issueTokenMultiChain(requestParameters: TokenizationApiIssueTokenMultiChainRequest) {
        return TokenizationApiFp(this.configuration).issueTokenMultiChain(requestParameters.createMultichainTokenRequestDto, requestParameters.idempotencyKey).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
    ...
    public reIssueTokenMultiChain(requestParameters: TokenizationApiReIssueTokenMultiChainRequest) {
        return TokenizationApiFp(this.configuration).reIssueTokenMultiChain(requestParameters.reissueMultichainTokenRequestDto, requestParameters.tokenLinkId, requestParameters.idempotencyKey).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
