...
// @ts-ignore
import { SupportedBlockChainsResponse } from '../models';
// @ts-ignore
...
export const ContractTemplatesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetContractTemplatesInitializationPhaseEnum} [initializationPhase] For standalone contracts use ON_DEPLOYMENT and for contracts that are behind proxies use POST_DEPLOYMENT
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @throws {RequiredError}
         */
        getSupportedBlockchainsByTemplateId: async (contractTemplateId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            assertParamExistsAndNotEmpty('getSupportedBlockchainsByTemplateId', 'contractTemplateId', contractTemplateId)
            const localVarPath = `/tokenization/templates/{contractTemplateId}/supported_blockchains`
                .replace(`{${"contractTemplateId"}}`, encodeURIComponent(String(contractTemplateId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ContractTemplatesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getSupportedBlockchainsByTemplateId(contractTemplateId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SupportedBlockChainsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSupportedBlockchainsByTemplateId(contractTemplateId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ContractTemplatesApi.getSupportedBlockchainsByTemplateId']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Upload a new contract template. This contract template will be available for the workspace
...
export const ContractTemplatesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Get supported blockchains for the template
         * @summary Get supported blockchains for the template
         * @param {ContractTemplatesApiGetSupportedBlockchainsByTemplateIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getSupportedBlockchainsByTemplateId(requestParameters: ContractTemplatesApiGetSupportedBlockchainsByTemplateIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<SupportedBlockChainsResponse> {
            return localVarFp.getSupportedBlockchainsByTemplateId(requestParameters.contractTemplateId, options).then((request) => request(axios, basePath));
        },
        /**
         * Upload a new contract template. This contract template will be available for the workspace
         * @summary Upload contract template
...
/**
 * Request parameters for getSupportedBlockchainsByTemplateId operation in ContractTemplatesApi.
 * @export
 * @interface ContractTemplatesApiGetSupportedBlockchainsByTemplateIdRequest
 */
export interface ContractTemplatesApiGetSupportedBlockchainsByTemplateIdRequest {
    /**
     * The Contract Template identifier
     * @type {string}
     * @memberof ContractTemplatesApiGetSupportedBlockchainsByTemplateId
     */
    readonly contractTemplateId: string
}
...
export class ContractTemplatesApi extends BaseAPI {
     ...
     * @memberof ContractTemplatesApi
     */
    public getSupportedBlockchainsByTemplateId(requestParameters: ContractTemplatesApiGetSupportedBlockchainsByTemplateIdRequest) {
        return ContractTemplatesApiFp(this.configuration).getSupportedBlockchainsByTemplateId(requestParameters.contractTemplateId).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
