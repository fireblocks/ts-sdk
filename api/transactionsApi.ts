...
import { AxiosRequestConfig, AxiosResponse } from 'axios';
    ...
    export class TransactionsApi {
        ...
        constructor(private configurationParameters:ConfigurationParameters = {}) {
            ...
            */
        public async cancelTransaction (txId: string, ) : Promise<CancelTransactionResponse> {
            ...
            */
        public async createTransaction (transactionRequest?: TransactionRequest, ) : Promise<CreateTransactionResponse> {
            ...
            */
        public async dropTransaction (txId: string, dropTransactionRequest?: DropTransactionRequest, ) : Promise<DropTransactionResponse> {
                ...
                let headers: any = {}
                        // verify required parameter 'txId' is not null or undefined
                        if (txId === null || txId === undefined) {
                        throw new Error('Required parameter txId was null or undefined when calling dropTransaction.');
                        }
            ...
            */
        public async estimateNetworkFee (assetId: string, ) : Promise<EstimatedNetworkFeeResponse> {
                const path = this.configuration.basePath + '/estimate_network_fee';
                let params: any = {};
                let headers: any = {}
                        // verify required parameter 'assetId' is not null or undefined
                        if (assetId === null || assetId === undefined) {
                        throw new Error('Required parameter assetId was null or undefined when calling estimateNetworkFee.');
                        }
            ...
            * Estimates the transaction fee for a transaction request. * Note: Supports all Fireblocks assets except ZCash (ZEC).
                ...
                * @param transactionRequest 
            */
        public async estimateTransactionFee (transactionRequest?: TransactionRequest, ) : Promise<EstimatedTransactionFeeResponse> {
            ...
            */
        public async freezeTransaction (txId: string, ) : Promise<FreezeTransactionResponse> {
                ...
                let headers: any = {}
                        // verify required parameter 'txId' is not null or undefined
                        if (txId === null || txId === undefined) {
                        throw new Error('Required parameter txId was null or undefined when calling freezeTransaction.');
                        }
            ...
            */
        public async getTransactionByExternalId (externalTxId: string, ) : Promise<TransactionResponse> {
                ...
                let headers: any = {}
                        ...
                        throw new Error('Required parameter externalTxId was null or undefined when calling getTransactionByExternalId.');
                        }
        ...
        public async getTransactionById (txId: string, ) : Promise<TransactionResponse> {
                ...
                let headers: any = {}
                        // verify required parameter 'txId' is not null or undefined
                        if (txId === null || txId === undefined) {
                        throw new Error('Required parameter txId was null or undefined when calling getTransactionById.');
                        }
            ...
            */
        public async getTransactions (before?: string, after?: string, status?: string, orderBy?: 'createdAt' | 'lastUpdated', sort?: 'ASC' | 'DESC', limit?: number, sourceType?: 'VAULT_ACCOUNT' | 'EXCHANGE_ACCOUNT' | 'INTERNAL_WALLET' | 'EXTERNAL_WALLET' | 'FIAT_ACCOUNT' | 'NETWORK_CONNECTION' | 'COMPOUND' | 'UNKNOWN' | 'GAS_STATION' | 'OEC_PARTNER' | 'END_USER_WALLET', sourceId?: string, destType?: 'VAULT_ACCOUNT' | 'EXCHANGE_ACCOUNT' | 'INTERNAL_WALLET' | 'EXTERNAL_WALLET' | 'FIAT_ACCOUNT' | 'NETWORK_CONNECTION' | 'COMPOUND' | 'ONE_TIME_ADDRESS' | 'OEC_PARTNER' | 'END_USER_WALLET', destId?: string, assets?: string, txHash?: string, ) : Promise<Array<TransactionResponse>> {
                const path = this.configuration.basePath + '/transactions';
                let params: any = {};
                let headers: any = {}
                    ...
                    if (typeof sourceType === 'object') {
                        for( const [key,value] of Object.entries(sourceType)){
                            ...
                            params['sourceType'] = ObjectSerializer.serialize(sourceType, "'VAULT_ACCOUNT' | 'EXCHANGE_ACCOUNT' | 'INTERNAL_WALLET' | 'EXTERNAL_WALLET' | 'FIAT_ACCOUNT' | 'NETWORK_CONNECTION' | 'COMPOUND' | 'UNKNOWN' | 'GAS_STATION' | 'OEC_PARTNER' | 'END_USER_WALLET'");
                    }
                    ...
                    if (typeof destType === 'object') {
                        for( const [key,value] of Object.entries(destType)){
                            ...
                            params['destType'] = ObjectSerializer.serialize(destType, "'VAULT_ACCOUNT' | 'EXCHANGE_ACCOUNT' | 'INTERNAL_WALLET' | 'EXTERNAL_WALLET' | 'FIAT_ACCOUNT' | 'NETWORK_CONNECTION' | 'COMPOUND' | 'ONE_TIME_ADDRESS' | 'OEC_PARTNER' | 'END_USER_WALLET'");
                    }
            ...
            */
        public async setConfirmationThresholdForTransaction (txId: string, setConfirmationsThresholdRequest?: SetConfirmationsThresholdRequest, ) : Promise<SetConfirmationsThresholdResponse> {
                ...
                let headers: any = {}
                        // verify required parameter 'txId' is not null or undefined
                        if (txId === null || txId === undefined) {
                        throw new Error('Required parameter txId was null or undefined when calling setConfirmationThresholdForTransaction.');
                        }
            ...
            * Overrides the required number of confirmations for transaction completion by transaction hash.
                ...
                * @param setConfirmationsThresholdRequest 
            */
        public async setConfirmationThresholdForTransactionByHash (txHash: string, setConfirmationsThresholdRequest?: SetConfirmationsThresholdRequest, ) : Promise<SetConfirmationsThresholdResponse> {
                ...
                let headers: any = {}
                        ...
                        throw new Error('Required parameter txHash was null or undefined when calling setConfirmationThresholdForTransactionByHash.');
                        }
            ...
            */
        public async unfreezeTransaction (txId: string, ) : Promise<UnfreezeTransactionResponse> {
                ...
                let headers: any = {}
                        // verify required parameter 'txId' is not null or undefined
                        if (txId === null || txId === undefined) {
                        throw new Error('Required parameter txId was null or undefined when calling unfreezeTransaction.');
                        }
        ...
        public async validateAddress (assetId: string, address: string, ) : Promise<ValidateAddressResponse> {
                ...
                let headers: any = {}
                        // verify required parameter 'assetId' is not null or undefined
                        if (assetId === null || assetId === undefined) {
                        throw new Error('Required parameter assetId was null or undefined when calling validateAddress.');
                        }
                    ...
                    if (typeof assetId === 'object') {
                        ...
                        throw new Error('Required parameter address was null or undefined when calling validateAddress.');
                        }
