...
// @ts-ignore
import { TrustProofOfAddressCreateResponse } from '../models';
// @ts-ignore
import { TrustProofOfAddressRequest } from '../models';
// @ts-ignore
import { TrustProofOfAddressResponse } from '../models';
/**
...
export const TravelRuleApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {TrustProofOfAddressRequest} trustProofOfAddressRequest 
         * @param {string} [idempotencyKey] A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createTrustProofOfAddress: async (trustProofOfAddressRequest: TrustProofOfAddressRequest, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            assertParamExists('createTrustProofOfAddress', 'trustProofOfAddressRequest', trustProofOfAddressRequest)
            const localVarPath = `/screening/travel_rule/providers/trust/proof_of_address`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(trustProofOfAddressRequest, localVarRequestOptions, configuration)
         ...
         * @param {string} transactionId Fireblocks transaction ID (UUID format)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getTrustProofOfAddress: async (transactionId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            assertParamExistsAndNotEmpty('getTrustProofOfAddress', 'transactionId', transactionId)
            const localVarPath = `/screening/travel_rule/providers/trust/proof_of_address/{transactionId}`
...
export const TravelRuleApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createTrustProofOfAddress(trustProofOfAddressRequest: TrustProofOfAddressRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TrustProofOfAddressCreateResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createTrustProofOfAddress(trustProofOfAddressRequest, idempotencyKey, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TravelRuleApi.createTrustProofOfAddress']?.[index]?.url;
         ...
         * @throws {RequiredError}
         */
        async getTrustProofOfAddress(transactionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TrustProofOfAddressResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTrustProofOfAddress(transactionId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TravelRuleApi.getTrustProofOfAddress']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Get VASP Details.  Returns information about a VASP that has the specified DID.
...
export const TravelRuleApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Creates a cryptographic proof of address ownership for TRUST network.
         * @summary Create Trust Network Proof of Address
         * @param {TravelRuleApiCreateTrustProofOfAddressRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createTrustProofOfAddress(requestParameters: TravelRuleApiCreateTrustProofOfAddressRequest, options?: RawAxiosRequestConfig): AxiosPromise<TrustProofOfAddressCreateResponse> {
            return localVarFp.createTrustProofOfAddress(requestParameters.trustProofOfAddressRequest, requestParameters.idempotencyKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves the TRUST-compatible encoded signature for a proof of address transaction. Send this signature directly to TRUST for verification.
         * @summary Retrieve Trust Network Proof of Address Signature
         * @param {TravelRuleApiGetTrustProofOfAddressRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getTrustProofOfAddress(requestParameters: TravelRuleApiGetTrustProofOfAddressRequest, options?: RawAxiosRequestConfig): AxiosPromise<TrustProofOfAddressResponse> {
...
/**
 * Request parameters for createTrustProofOfAddress operation in TravelRuleApi.
 * @export
 * @interface TravelRuleApiCreateTrustProofOfAddressRequest
 */
export interface TravelRuleApiCreateTrustProofOfAddressRequest {
    /**
     * 
     * @type {TrustProofOfAddressRequest}
     * @memberof TravelRuleApiCreateTrustProofOfAddress
     */
    readonly trustProofOfAddressRequest: TrustProofOfAddressRequest
...
/**
 * Request parameters for getTrustProofOfAddress operation in TravelRuleApi.
 * @export
 * @interface TravelRuleApiGetTrustProofOfAddressRequest
 */
export interface TravelRuleApiGetTrustProofOfAddressRequest {
    /**
     * Fireblocks transaction ID (UUID format)
     * @type {string}
     * @memberof TravelRuleApiGetTrustProofOfAddress
     */
...
export class TravelRuleApi extends BaseAPI {
     ...
     */
    public createTrustProofOfAddress(requestParameters: TravelRuleApiCreateTrustProofOfAddressRequest) {
        return TravelRuleApiFp(this.configuration).createTrustProofOfAddress(requestParameters.trustProofOfAddressRequest, requestParameters.idempotencyKey).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
     ...
     * @memberof TravelRuleApi
     */
    public getTrustProofOfAddress(requestParameters: TravelRuleApiGetTrustProofOfAddressRequest) {
        return TravelRuleApiFp(this.configuration).getTrustProofOfAddress(requestParameters.transactionId).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
