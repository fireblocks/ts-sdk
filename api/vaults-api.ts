...
export const VaultsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [limit] The maximum number of vault wallets in a single response.   The default is 200 and the maximum is 1000. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @param {string} [after] 
         * @param {number} [limit] 
         * @param {Array<string>} [tagIds] DEPRECATED - use includeTagIds instead
         * @param {Array<string>} [includeTagIds] List of tag IDs to include. Vault accounts with any of these tags will be included
         * @param {Array<string>} [excludeTagIds] List of tag IDs to exclude. Vault accounts with any of these tags will be filtered out
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPagedVaultAccounts: async (namePrefix?: string, nameSuffix?: string, minAmountThreshold?: number, assetId?: string, orderBy?: GetPagedVaultAccountsOrderByEnum, before?: string, after?: string, limit?: number, tagIds?: Array<string>, includeTagIds?: Array<string>, excludeTagIds?: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const VaultsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMaxBipIndexUsed(vaultAccountId: string, assetId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetMaxBipIndexUsedResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMaxBipIndexUsed(vaultAccountId, assetId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VaultsApi.getMaxBipIndexUsed']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * **UTXO assets only.**  Retrieve the maximum amount of the specified asset that can be spent in a single transaction from the specified vault account.  **Endpoint Permissions:** Admin, Non-Signing Admin, Signer, Approver, Editor, Viewer. 
         ...
         * @throws {RequiredError}
         */
        async getPagedVaultAccounts(namePrefix?: string, nameSuffix?: string, minAmountThreshold?: number, assetId?: string, orderBy?: GetPagedVaultAccountsOrderByEnum, before?: string, after?: string, limit?: number, tagIds?: Array<string>, includeTagIds?: Array<string>, excludeTagIds?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VaultAccountsPagedResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPagedVaultAccounts(namePrefix, nameSuffix, minAmountThreshold, assetId, orderBy, before, after, limit, tagIds, includeTagIds, excludeTagIds, options);
            const index = configuration?.serverIndex ?? 0;
...
export const VaultsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Retrieves the maximum BIP44 address index and change address index used for a specific asset in a vault account (BIP44 standard).
         * @summary Get maximum BIP44 index used
         * @param {VaultsApiGetMaxBipIndexUsedRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMaxBipIndexUsed(requestParameters: VaultsApiGetMaxBipIndexUsedRequest, options?: RawAxiosRequestConfig): AxiosPromise<GetMaxBipIndexUsedResponse> {
            return localVarFp.getMaxBipIndexUsed(requestParameters.vaultAccountId, requestParameters.assetId, options).then((request) => request(axios, basePath));
        },
        /**
         * **UTXO assets only.**  Retrieve the maximum amount of the specified asset that can be spent in a single transaction from the specified vault account.  **Endpoint Permissions:** Admin, Non-Signing Admin, Signer, Approver, Editor, Viewer. 
         * @summary Get max spendable amount in a transaction
...
/**
 * Request parameters for getMaxBipIndexUsed operation in VaultsApi.
 * @export
 * @interface VaultsApiGetMaxBipIndexUsedRequest
 */
export interface VaultsApiGetMaxBipIndexUsedRequest {
    /**
     * The ID of the vault account
     * @type {string}
     * @memberof VaultsApiGetMaxBipIndexUsed
     */
    readonly vaultAccountId: string
...
export class VaultsApi extends BaseAPI {
     ...
     * @memberof VaultsApi
     */
    public getMaxBipIndexUsed(requestParameters: VaultsApiGetMaxBipIndexUsedRequest) {
        return VaultsApiFp(this.configuration).getMaxBipIndexUsed(requestParameters.vaultAccountId, requestParameters.assetId).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
    ...
    public getPagedVaultAccounts(requestParameters: VaultsApiGetPagedVaultAccountsRequest = {}) {
        return VaultsApiFp(this.configuration).getPagedVaultAccounts(requestParameters.namePrefix, requestParameters.nameSuffix, requestParameters.minAmountThreshold, requestParameters.assetId, requestParameters.orderBy, requestParameters.before, requestParameters.after, requestParameters.limit, requestParameters.tagIds, requestParameters.includeTagIds, requestParameters.excludeTagIds).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
