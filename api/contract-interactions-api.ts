...
// @ts-ignore
import { ContractAddressResponse } from '../models';
// @ts-ignore
...
export const ContractInteractionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getContractAddress: async (baseAssetId: string, txHash: string, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            assertParamExistsAndNotEmpty('getContractAddress', 'baseAssetId', baseAssetId)
            assertParamExistsAndNotEmpty('getContractAddress', 'txHash', txHash)
            const localVarPath = `/contract_interactions/base_asset_id/{baseAssetId}/tx_hash/{txHash}`
                .replace(`{${"baseAssetId"}}`, encodeURIComponent(String(baseAssetId)))
...
export const ContractInteractionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getContractAddress(baseAssetId: string, txHash: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContractAddressResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getContractAddress(baseAssetId, txHash, idempotencyKey, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ContractInteractionsApi.getContractAddress']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Return deployed contract\'s ABI by blockchain native asset id and contract address. </br>Endpoint Permission: Admin, Non-Signing Admin, Signer, Approver, Editor, and Viewer.
...
export const ContractInteractionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Retrieve the contract address by blockchain native asset ID and transaction hash
         * @summary Get contract address by transaction hash
         * @param {ContractInteractionsApiGetContractAddressRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getContractAddress(requestParameters: ContractInteractionsApiGetContractAddressRequest, options?: RawAxiosRequestConfig): AxiosPromise<ContractAddressResponse> {
...
/**
 * Request parameters for getContractAddress operation in ContractInteractionsApi.
 * @export
 * @interface ContractInteractionsApiGetContractAddressRequest
 */
export interface ContractInteractionsApiGetContractAddressRequest {
    /**
     * The blockchain base assetId
     * @type {string}
     * @memberof ContractInteractionsApiGetContractAddress
     */
    readonly baseAssetId: string
...
export class ContractInteractionsApi extends BaseAPI {
     ...
     * @memberof ContractInteractionsApi
     */
    public getContractAddress(requestParameters: ContractInteractionsApiGetContractAddressRequest) {
        return ContractInteractionsApiFp(this.configuration).getContractAddress(requestParameters.baseAssetId, requestParameters.txHash, requestParameters.idempotencyKey).then((request) => request(this.axios, this.basePath)).then(convertToFireblocksResponse);
    }
