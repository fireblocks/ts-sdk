...
*ApprovalsBetaApi* | [**approveApproval**](docs/apis/ApprovalsBetaApi.md#approveApproval) | **POST** /approvals/{requestId}/approve | Approve an approval request
*ApprovalsBetaApi* | [**createApprovalKey**](docs/apis/ApprovalsBetaApi.md#createApprovalKey) | **POST** /management/api_users/{userId}/approval_keys | Register an approval key
*ApprovalsBetaApi* | [**deleteApprovalKey**](docs/apis/ApprovalsBetaApi.md#deleteApprovalKey) | **DELETE** /management/api_users/{userId}/approval_keys/{keyId} | Delete an approval key
...
*ApprovalsBetaApi* | [**getApprovalKeys**](docs/apis/ApprovalsBetaApi.md#getApprovalKeys) | **GET** /management/api_users/{userId}/approval_keys | List approval keys
...
*ComplianceApi* | [**activateArsConfig**](docs/apis/ComplianceApi.md#activateArsConfig) | **POST** /screening/ars/config/activate | Activate ARS (Address Registry Screening)
...
*ComplianceApi* | [**deleteLegalEntity**](docs/apis/ComplianceApi.md#deleteLegalEntity) | **DELETE** /legal_entities/{legalEntityId} | Delete a legal entity
...
*ComplianceApi* | [**optOutAddressRegistryTenant**](docs/apis/ComplianceApi.md#optOutAddressRegistryTenant) | **DELETE** /address_registry/tenant | Opt the workspace out of the address registry
...
*GenieBetaApi* | [**createGenieSession**](docs/apis/GenieBetaApi.md#createGenieSession) | **POST** /genie/sessions | Create a Genie session
*GenieBetaApi* | [**sendGenieMessage**](docs/apis/GenieBetaApi.md#sendGenieMessage) | **POST** /genie/sessions/{sessionId}/messages | Send a message to a Genie session
...
*PolicyEditorV2Api* | [**getActivePolicy**](docs/apis/PolicyEditorV2Api.md#getActivePolicy) | **GET** /policy/active_policy | Get the active policy and its validation by policy type
...
*VaultsApi* | [**activateUsdcGatewayWalletBeta**](docs/apis/VaultsApi.md#activateUsdcGatewayWalletBeta) | **POST** /vault/accounts/{vaultAccountId}/usdc_gateway/activate | Activate a USDC Gateway wallet
...
## Documentation for Models
 ...
 - [ApprovalApiKey](docs/models/ApprovalApiKey.md)
 - [ApprovalApiPublicKey](docs/models/ApprovalApiPublicKey.md)
 - [ApprovalRequest](docs/models/ApprovalRequest.md)
 - [ApprovalRequestItem](docs/models/ApprovalRequestItem.md)
 - [ApproveApprovalRequest](docs/models/ApproveApprovalRequest.md)
 ...
 - [ArsConfigResponse](docs/models/ArsConfigResponse.md)
 ...
 - [AssignVaultsToLegalEntityRequest](docs/models/AssignVaultsToLegalEntityRequest.md)
 - [AssignVaultsToLegalEntityResponse](docs/models/AssignVaultsToLegalEntityResponse.md)
 - [AttachDetachUtxoLabelsRequest](docs/models/AttachDetachUtxoLabelsRequest.md)
 - [AttachDetachUtxoLabelsResponse](docs/models/AttachDetachUtxoLabelsResponse.md)
 - [AuditEventTypeEnum](docs/models/AuditEventTypeEnum.md)
 ...
 - [ByorkConfigResponse](docs/models/ByorkConfigResponse.md)
 - [ByorkSetTimeoutsRequest](docs/models/ByorkSetTimeoutsRequest.md)
 - [ByorkSetVerdictEnum](docs/models/ByorkSetVerdictEnum.md)
 - [ByorkTimeoutRange](docs/models/ByorkTimeoutRange.md)
 - [ByorkVerdictEnum](docs/models/ByorkVerdictEnum.md)
 ...
 - [BypassReasonEnum](docs/models/BypassReasonEnum.md)
 ...
 - [CipsAddress](docs/models/CipsAddress.md)
 - [CipsDestination](docs/models/CipsDestination.md)
 - [CipsPaymentInfo](docs/models/CipsPaymentInfo.md)
 ...
 - [ComplianceScreeningStatusEnum](docs/models/ComplianceScreeningStatusEnum.md)
 ...
 - [ConnectorStatusEnum](docs/models/ConnectorStatusEnum.md)
 - [ConnectorVerdictEnum](docs/models/ConnectorVerdictEnum.md)
 ...
 - [CreateOffersRequest](docs/models/CreateOffersRequest.md)
 ...
 - [CreateReportRequest](docs/models/CreateReportRequest.md)
 - [CreateReportResponse](docs/models/CreateReportResponse.md)
 ...
 - [FpsUkAddress](docs/models/FpsUkAddress.md)
 - [FpsUkDestination](docs/models/FpsUkDestination.md)
 - [FpsUkPaymentInfo](docs/models/FpsUkPaymentInfo.md)
 ...
 - [GenieCreateSessionResponse](docs/models/GenieCreateSessionResponse.md)
 - [GenieSendMessageRequest](docs/models/GenieSendMessageRequest.md)
 ...
 - [GetPositionsResponse](docs/models/GetPositionsResponse.md)
 - [GetProvidersResponse](docs/models/GetProvidersResponse.md)
 - [GetRoutingPolicyAssetGroupsResponse](docs/models/GetRoutingPolicyAssetGroupsResponse.md)
 - [GetScreeningResultResponse](docs/models/GetScreeningResultResponse.md)
 ...
 - [GleifData](docs/models/GleifData.md)
 - [GleifOtherLegalEntityName](docs/models/GleifOtherLegalEntityName.md)
 ...
 - [IdentificationPolicyOverride](docs/models/IdentificationPolicyOverride.md)
 ...
 - [InstaPayAddress](docs/models/InstaPayAddress.md)
 - [InstaPayDestination](docs/models/InstaPayDestination.md)
 - [InstaPayPaymentInfo](docs/models/InstaPayPaymentInfo.md)
 ...
 - [IssueApiUserPairingTokenResponse](docs/models/IssueApiUserPairingTokenResponse.md)
 ...
 - [ListUtxosResponse](docs/models/ListUtxosResponse.md)
 - [ListVaultsForRegistrationResponse](docs/models/ListVaultsForRegistrationResponse.md)
 ...
 - [NequiAddress](docs/models/NequiAddress.md)
 - [NequiDestination](docs/models/NequiDestination.md)
 - [NequiPaymentInfo](docs/models/NequiPaymentInfo.md)
 ...
 - [PesonetAddress](docs/models/PesonetAddress.md)
 - [PesonetDestination](docs/models/PesonetDestination.md)
 - [PesonetPaymentInfo](docs/models/PesonetPaymentInfo.md)
 ...
 - [PolicyMetadataEntry](docs/models/PolicyMetadataEntry.md)
 ...
 - [QuoteExecutionTypeEnum](docs/models/QuoteExecutionTypeEnum.md)
 ...
 - [QuoteOffer](docs/models/QuoteOffer.md)
 - [QuoteOfferType](docs/models/QuoteOfferType.md)
 - [QuotesResponse](docs/models/QuotesResponse.md)
 - [Rate](docs/models/Rate.md)
 - [RateOffer](docs/models/RateOffer.md)
 - [RateOfferType](docs/models/RateOfferType.md)
 - [RatesRequest](docs/models/RatesRequest.md)
 - [RatesResponse](docs/models/RatesResponse.md)
 ...
 - [ReasonForPaymentEnum](docs/models/ReasonForPaymentEnum.md)
 ...
 - [RegisterApprovalApiKeyRequest](docs/models/RegisterApprovalApiKeyRequest.md)
 - [RegisterApprovalApiKeyResponse](docs/models/RegisterApprovalApiKeyResponse.md)
 - [RegisterLegalEntityRequest](docs/models/RegisterLegalEntityRequest.md)
 ...
 - [ReportJobResponse](docs/models/ReportJobResponse.md)
 - [ReportListResponse](docs/models/ReportListResponse.md)
 ...
 - [RiskLevelEnum](docs/models/RiskLevelEnum.md)
 ...
 - [RuleActionEnum](docs/models/RuleActionEnum.md)
 - [RuleCondition](docs/models/RuleCondition.md)
 - [RuleConditionOperatorEnum](docs/models/RuleConditionOperatorEnum.md)
 - [RuleSet](docs/models/RuleSet.md)
 ...
 - [ScreeningInput](docs/models/ScreeningInput.md)
 - [ScreeningMetadataConfig](docs/models/ScreeningMetadataConfig.md)
 - [ScreeningOperationEnum](docs/models/ScreeningOperationEnum.md)
 ...
 - [ScreeningOutcomeEnum](docs/models/ScreeningOutcomeEnum.md)
 - [ScreeningPayload](docs/models/ScreeningPayload.md)
 - [ScreeningPolicyAmount](docs/models/ScreeningPolicyAmount.md)
 - [ScreeningPolicyAmountRange](docs/models/ScreeningPolicyAmountRange.md)
 - [ScreeningPolicyCurrency](docs/models/ScreeningPolicyCurrency.md)
 ...
 - [StakingErrorSchema](docs/models/StakingErrorSchema.md)
 ...
 - [StepConfig](docs/models/StepConfig.md)
 - [StepOperationConfig](docs/models/StepOperationConfig.md)
 - [StepResult](docs/models/StepResult.md)
 - [StepResultMetadata](docs/models/StepResultMetadata.md)
 ...
 - [TransactionTag](docs/models/TransactionTag.md)
 - [TransferConfigOperation](docs/models/TransferConfigOperation.md)
 - [TransferDirectionEnum](docs/models/TransferDirectionEnum.md)
 ...
 - [TravelRuleProvider](docs/models/TravelRuleProvider.md)
 ...
 - [TravelRuleVASPCompliancePhaseData](docs/models/TravelRuleVASPCompliancePhaseData.md)
 - [TravelRuleVASPExternalEntity](docs/models/TravelRuleVASPExternalEntity.md)
 - [TravelRuleVASPExternalEntityConfig](docs/models/TravelRuleVASPExternalEntityConfig.md)
 - [TravelRuleVASPExternalEntityRegistration](docs/models/TravelRuleVASPExternalEntityRegistration.md)
 ...
 - [TriggerRuleOutcomeEnum](docs/models/TriggerRuleOutcomeEnum.md)
 - [TriggerScreeningRequest](docs/models/TriggerScreeningRequest.md)
 - [TriggerScreeningResponse](docs/models/TriggerScreeningResponse.md)
 ...
 - [UsdcGatewayWalletStatusResponse](docs/models/UsdcGatewayWalletStatusResponse.md)
 ...
 - [UtxoIdentifier](docs/models/UtxoIdentifier.md)
 ...
 - [WebhookCustomHeaders](docs/models/WebhookCustomHeaders.md)
 - [WebhookCustomHeadersResponse](docs/models/WebhookCustomHeadersResponse.md)
 ...
 - [WorkflowStatusEnum](docs/models/WorkflowStatusEnum.md)
