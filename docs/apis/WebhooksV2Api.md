...
[**deleteNotification**](#deleteNotification) | **DELETE** /webhooks/{webhookId}/notifications/{notificationId} | Delete notification by id
...
import { readFileSync } from 'fs';
import { Fireblocks, BasePath } from '@fireblocks/ts-sdk';
import type { FireblocksResponse, WebhooksV2ApiDeleteNotificationRequest } from '@fireblocks/ts-sdk';
...
let body: WebhooksV2ApiDeleteNotificationRequest = {
...
fireblocks.webhooksV2.deleteNotification(body).then((res: FireblocksResponse<any>) => {
  console.log('API called successfully. Returned data: ' + JSON.stringify(res, null, 2));
}).catch((error:any) => console.error(error));
```
