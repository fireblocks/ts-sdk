...
|**amountUSD** | **string** | Transaction amount in USD (optional) | [optional] [default to undefined]|
...
|**assetId** | **string** | Asset identifier (e.g., ETH, BTC, USDC) | [optional] [default to undefined]|
