...
|------------ | ------------- | ------------- | -------------|
|**status** | [**TRLinkRegistrationStatusEnum**](TRLinkRegistrationStatusEnum.md) |  | [default to undefined]|
...
|**result** | [**TRLinkProviderResult**](TRLinkProviderResult.md) |  | [optional] [default to undefined]|
