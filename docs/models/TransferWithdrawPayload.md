...
|**offerTransactionId** | **string** | The Fireblocks transaction id of the OUTGOING transfer offer being withdrawn. | [default to undefined]|


## Enum: TransferWithdrawPayloadAssetEnum
