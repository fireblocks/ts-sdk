...
|------------ | ------------- | ------------- | -------------|
|**action** | [**TRLinkPostScreeningAction**](TRLinkPostScreeningAction.md) |  | [default to undefined]|
...
|**trmStatus** | [**TRLinkTrmStatus**](TRLinkTrmStatus.md) |  | [optional] [default to undefined]|
