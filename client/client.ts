...
export class Fireblocks {
    ...
    get onchainData(): OnchainDataApi {
        return this._onchainData ?? new OnchainDataApi(this.config, undefined, this.axiosManager.axios);
    }
    ...
    get trLink(): TRLinkApi {
        return this._trLink ?? new TRLinkApi(this.config, undefined, this.axiosManager.axios);
    }
    get tags(): TagsApi {
